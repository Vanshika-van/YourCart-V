...
function Contact() {
  return (
    <div className=' w-[99vw] md:w-[100vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px] '>
     ...
     <img src={contact} alt="" className='lg:w-[65%] w-[80%] shadow-md shadow-black rounded-sm' />
      </div>
      <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px] '>
       <p className='lg:w-[80%] w-[100%] text-[white] font-bold lg:text-[16px] text-[15px]'>Our Store</p>  
       <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
        <p>12345 Random Station</p>
        <p>random city,state,India</p>
       </p>
       <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
        <p>tel: +91-987643210 </p>
        <p>Email: admin@yourcart.com</p>
       </p>
       <p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] font-bold'>Careers at YourCart</p>
