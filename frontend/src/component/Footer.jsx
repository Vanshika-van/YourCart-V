...
<p className='text-[15px] text-[#1e2223] hidden md:block'>OneCart is your all-in-one online shopping destination, offering top-quality product, unbeatable deals, and fast delivery-all backed by trusted service designed to make your life easier every day. </p>
    <p className='text-[15px] text-[#1e2223] flex md:hidden'>Fast. Easy. Reliable. YourCart Shopping</p>
...
<ul>
    ...
    <li className='text-[15px] text-[#1e2223] hidden md:block'>About us </li>
...
<ul>
    <li className='text-[15px] text-[#1e2223] hidden md:block'>+91-9874567895</li>
    <li className='text-[15px] text-[#1e2223] hidden md:block'>contact@yourcart.com </li>
    <li className='text-[15px] text-[#1e2223] hidden md:block'>+1-123-456-7890</li>
    <li className='text-[15px] text-[#1e2223] hidden md:block'>admin@yourcart.com</li>
</ul>
</div>
      </div>
  ...
  Copyright 2025@yourcart.com-All Rights Reserved
     </div>
    </div>
  )
}
